...
function HeroSection() {
    return (
        <section className="hero_section">
            <img className="banner-animate-img animate-img-1 top_image_bounce" src="assets/elements_dots.svg" alt="img"></img>
            <img className="banner-animate-img animate-img-2 left_image_bounce" src="assets/elements_circel.svg" alt="img"></img>
            <div className="container mx-auto px-4">
                <div className="flex flex-wrap justify-between">
                    ...
                    <div className="w-full lg:w-5/12 md:w-6/12 mt-5 lg:mt-0 banner_thumb" data-aos="fade-left" data-aos-delay="100" data-aos-duration="1500">
                        <div className="banner-animate-img banner-animate-img-1 top_image_bounce" alt="img">
                            <img src="assets/trophy.png" alt="" />
                            <h4>Award Wining <br />Agency</h4>
                        </div>
                        <div className="banner-animate-img banner-animate-img-2 left_image_bounce" alt="img">
